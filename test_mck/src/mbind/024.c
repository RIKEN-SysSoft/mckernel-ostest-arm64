/* 024.c COPYRIGHT FUJITSU LIMITED 2017 */
#include <stdio.h>
#include <stdlib.h>
#include <numaif.h>
#include <errno.h>
...
RUN_FUNC(TEST_SUITE, TEST_NUMBER)
{
	...
	l_ret = mbind(buf, PAGE_SIZE, MPOL_INTERLEAVE, &mbind_node_mask, BITS_PER_LONG, 0);
	tp_assert(l_ret==0, "mbind(mode=MPOL_INTERLEAVE) error");
