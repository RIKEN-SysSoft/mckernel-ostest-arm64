...
RUN_FUNC(TEST_SUITE, TEST_NUMBER)
{
	...
	l_ret = mbind(buf, PAGE_SIZE, MPOL_BIND | MPOL_F_RELATIVE_NODES,
				&mbind_node_mask, BITS_PER_LONG, 0);
	...
	tp_assert(mode==(MPOL_BIND|MPOL_F_RELATIVE_NODES), "mode != (MPOL_BIND|MPOL_F_RELATIVE_NODES)");
