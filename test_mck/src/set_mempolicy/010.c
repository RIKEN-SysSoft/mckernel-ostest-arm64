/* 010.c COPYRIGHT FUJITSU LIMITED 2017 */
#include <stdio.h>
#include <stdlib.h>
#include <numaif.h>
#include <errno.h>
...
RUN_FUNC(TEST_SUITE, TEST_NUMBER)
{
	...
	l_ret = set_mempolicy(MPOL_BIND | MPOL_F_RELATIVE_NODES, &set_node_mask, BITS_PER_LONG);
	...
	tp_assert(mode==(MPOL_BIND | MPOL_F_RELATIVE_NODES), "mode != MPOL_BIND");
